...
public class LifeRouletteV29Generator : EditorWindow
{
    [MenuItem("Tools/Generate Life Roulette V29")]
    public static void Generate()
    {
        string v9Path = "Assets/Textures/life_roulette_v9.png";
        string dstPath = "Assets/Textures/life_roulette_v29.png";
        ...
        // --- 最新の ISpriteEditorDataProvider を使用したスライス設定 ---
