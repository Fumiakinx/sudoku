...
public class UIManager : MonoBehaviour
{
    ...
    private void Update() {
        ...
        if (Keyboard.current != null && Keyboard.current.escapeKey.wasPressedThisFrame) {
            Debug.Log("[UIManager] ESC key pressed. Returning to Menu.");
            BackToMenu();
        }
    }
    ...
    private void InitializeGame() {
        Debug.Log("[LIFE-LOG] UIManager.InitializeGame ENTER");
        Debug.Log("[DIAGNOSTIC] UIManager: InitializeGame sequence started.");
        if (panelManager != null) {
            Debug.Log("[DIAGNOSTIC]   - Configuring Panels via PanelManager...");
            ...
            Debug.LogWarning("[DIAGNOSTIC]   - PanelManager is NULL. Skipping panel config.");
        }

        if (inputPanelController != null) {
            Debug.Log("[DIAGNOSTIC]   - Initializing InputPanelController...");
            inputPanelController.Initialize(OnInputNumberClicked);
        }

        Debug.Log($"[DIAGNOSTIC]   - Game Initialization Status: {(SudokuGameState.NeedsInitialization ? "NEW GAME REQUESTED" : "DEFAULT START")}");
        ...
        Debug.Log("[DIAGNOSTIC] UIManager: InitializeGame sequence completed.");
    }
